...
export default function LoginForm() {
	...
	return (
		...
		<LoginFormStyled action='submit' onSubmit={handleSubmit}>
			<StyledH1>Bienvenue chez nous !</StyledH1>
					<StyledSpan></StyledSpan>
			
				<StyledH2>Connectez-vous</StyledH2>
					<StyledDiv>
					
						<StyledSvg1 xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
						...
						<StyledSvg2 xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
